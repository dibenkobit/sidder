 ...
 * things you said, and force is only an answer to the journal, which is something sidder
 * observed. It overrules what sidder remembers, never what you declared.
 */
 ...
 * mistake worth stopping for. sidder does not quietly widen your selection to fix it.
 */
